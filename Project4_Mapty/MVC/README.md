...
5. Feature Impovement:
   ...
   - 1.Improve workout list UX by highlighting the active item and conditionally rendering action buttons to reduce visual noise.
   - 2. Handling complex UI state transitions (edit mode, show-all view, and item-level actions) requires clear state ownership and guard conditions, which I intentionally limited in v1 to keep the flow deterministic.
   - 3. display weather data at workout timing and place
   - 4. use geocode loction coordinate
